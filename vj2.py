...
class Createuser:
    ...
    def widgets(self):
        ...
        crf1= Frame(self.master, width=1600, height=50, bg="pink", relief=SUNKEN)
        crf1.pack(side=TOP)
        lblinfo = Label(crf1, font=('Ink Free', 100, 'bold',), text="VJ Cafe", bg="alice blue", bd=10, fg="Purple",
                        anchor='w')
       ...
       # lblinfo = Label(self.crf, font=('ariel', 20, 'bold',), text=localtime, fg="Purple", bd=10, anchor='w')
        ...
        Label(self.crff, text='Username: ', font=('', 15), pady=5, padx=5).grid(sticky=W)
        Entry(self.crff, textvariable=self.n_username, bd=3, font=('', 15)).grid(row=0, column=1)

        Label(self.crff, text='Password: ', font=('', 15), pady=5, padx=5).grid(sticky=W)
        Entry(self.crff, textvariable=self.n_password, bd=3, font=('', 15), show='*').grid(row=1, column=1)
        ...
        Label(self.crff, text='Email Id: ', font=('', 15), pady=5, padx=5).grid(row=5, column=0)
        Entry(self.crff, textvariable=self.n_email, bd=3, font=('', 15)).grid(row=5, column=1)
        Button(self.crff, text='Send OTP', background='lightgrey', bd=2, font=('', 13), padx=6, pady=6,
               command=self.otp).grid(row=7, column=0)
        Entry(self.crff, textvariable=self.n_otp, bd=3, font=('', 15)).grid(row=7, column=1)
        Button(self.crff, text='Create Account', background='lightgrey', bd=2, font=('', 13), padx=6, pady=6,
               command=self.new_user).grid(row=11, column=0)
        Button(self.crff, text='Go to Login', background='lightgrey', bd=2, font=('', 13), padx=6, pady=6,
               command=self.log).grid(row=11, column=1)
...
class Billing:
    def __init__(self, master):
        ...
        # ----labelinfo----
        lblinfo = Label(tops, font=('Ink Free', 100, 'bold',), text="VJ Cafe", bg="alice blue",bd=10, fg="Purple", anchor='w')
        lblinfo.grid(row=0, column=0)
...
<![endif]-->
       ...
       # def email1(emailid):
        ...
        Fries = StringVar()
        Fries.set("0")
        lblFries = Label(lf, font=('arial', '16', 'bold'), text="Large Fries", bd=16, anchor='w', bg="alice blue")
        ...
        Pasta = StringVar()
        Pasta.set("0")
        lblVeg = Label(lf, bg="alice blue", font=('arial', '16', 'bold'), text="Pasta", bd=16, anchor='w')
        ...
        Sizzlers = StringVar()
        Sizzlers.set("0")
        lblChicken = Label(lf, font=('arial', '16', 'bold'), bg="alice blue", text="Sizzlers", bd=16, anchor='w')
        ...
        Drinks = StringVar()
        Drinks.set("0")
        lblDrinks = Label(lf, font=('arial', '16', 'bold'), text="Drinks", bd=16, anchor='w', bg="alice blue")
        ...
        Pizza = StringVar()
        Pizza.set("0")
        lblDrinks = Label(lf, font=('arial', '16', 'bold'), text="Pizza", bd=16, anchor='w', bg="alice blue")
        ...
        Burger = StringVar()
        Burger.set("0")
        lblBurger = Label(lf, font=('arial', '16', 'bold'), text="Burger", bd=16, anchor='w', bg="alice blue")
        ...
        Cookies = StringVar()
        Cookies.set("0")
        lblservice = Label(lf, font=('arial', '16', 'bold'), text="Cookies ", bd=16, anchor='w', bg="alice blue")
        ...
        Tax = StringVar()
        lblTax = Label(lf, font=('arial', '16', 'bold'), text="Tax", bd=16, anchor='w', bg="alice blue")
        ...
        Cheesecake.set("0")
        lblservice = Label(lf, font=('arial', '16', 'bold'), text="Cheesecake ", bd=16, anchor='w', bg="alice blue")
        ...
        TotalCost = StringVar()
        lblTotalCost = Label(lf, font=('arial', '16', 'bold'), text="Total", bd=16, anchor='w', bg="alice blue")
        ...
        btnExit = Button(lf, padx=16, pady=8, bd=10, fg='Black', font=('arial', '16', 'bold'), width=10, text="Logout",
                         bg='pink', command=qExit).grid(row=8, column=4)

        btnReceipt = Button(lf, padx=16, pady=8, bd=10, fg='Black', font=('arial', '16', 'bold'), width=10,
...
'''from: VJCAFE<dishacheck123@gmail.com>
to:	You
date:	Today's date
subject:ORDER PLACED\n

Thank you for ordering from VJ CAFE! Your order will be at your door soon!
HAPPY EATING!!!'''