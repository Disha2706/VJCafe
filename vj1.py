...
class main:
    ...
    def widgets(self):
        ...
        lbluser = Label(self.logf, text="Username", image=self.user_icon, compound=LEFT,font=("times new roman", 20, "bold"), bg="white").grid(row=1, column=0, padx=20, pady=10)
        ...
        user1=Label(self.crf, text='Username: ', font=('', 15), pady=5, padx=5).grid(sticky=W)
        txtuser1=Entry(self.crf, textvariable=self.n_username, bd=3, font=('', 15)).grid(row=0, column=1)

        pass1=Label(self.crf, text='Password: ', font=('', 15), pady=5, padx=5).grid(sticky=W)
        txtpass1=Entry(self.crf, textvariable=self.n_password, show='*',bd=3, font=('', 15)).grid(row=1, column=1)
        ...
        email1=Label(self.crf, text='Email Id: ', font=('', 15), pady=5, padx=5).grid(row=5, column=0)
        txtemail1=Entry(self.crf, textvariable=self.n_email, bd=3, font=('', 15)).grid(row=5, column=1)

        cr=Button(self.crf, text='Create Account', background='lightgrey', bd=2, font=('', 13), padx=6, pady=6,
               command=self.new_user).grid(row=11, column=0)
        log=Button(self.crf, text='Go to Login', background='lightgrey', bd=2, font=('', 13), padx=6, pady=6,
