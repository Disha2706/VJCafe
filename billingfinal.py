...
class Login:
    def __init__(self,master):
        ...
        self.Title=Label(self.frame,text="RESTAURANT",font=('arial',40,'bold'),bg='pink',fg='Cornsilk')
...
class Billing:
    def __init__(self,master):
        ...
        def Receipt():
            ...
            #txtReceipt.insert(END,'Receipt Ref:\t\t\t'+rf.get()+'\t'+localtime.get()+"\n")
        ...
        txtReceipt = Text(rf, width=70, height=19, bg="white", bd=4, font=('times new roman', 12, 'bold'))
        txtReceipt.grid(row=0, column=0)
        # --------------------------Buttons-----------------------------------------------------
        btnprice = Button(lf, padx=16, pady=8, bd=5, fg="black", font=('ariel', 16, 'bold'), width=10, text="PRICE",
                          bg="pink",command=price)
        btnprice.grid(row=8, column=0)
        btnTotal = Button(lf, padx=16, pady=8, bd=5, fg='Black', font=('arial', '16', 'bold'), width=10, text="Total",
                          bg='pink', command=Ref).grid(row=8, column=1)
        btnReset = Button(lf, padx=16, pady=8, bd=5, fg='Black', font=('arial', '16', 'bold'), width=10, text="Reset",
                          bg='pink', command=Reset).grid(row=8, column=2)
        btnExit = Button(lf, padx=16, pady=8, bd=5, fg='Black', font=('arial', '16', 'bold'), width=10, text="Exit",
                         bg='pink', command=qExit).grid(row=8, column=4)
        btnReceipt = Button(lf, padx=16, pady=8, bd=5, fg='Black', font=('arial', '16', 'bold'), width=10,
